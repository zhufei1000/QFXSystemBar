...
local englishOverrides = {
    ...
    ["Left Click Mount"] = "Left Click",
    ["Middle Click Mount"] = "Middle Click",
    ["Right Click Mount"] = "Right Click",
    ...
    ["Toggle visibility and drag the preview icons to adjust button order on the system bar."] = "Toggle buttons and drag icons to reorder.",
    ["Checked buttons are shown on the system bar. Drag the preview icons or use the arrows to adjust order."] = "Checked buttons show. Drag icons or use arrows to reorder.",
    ["Checked buttons are shown on the system bar. Drag the preview icons to adjust order."] = "Checked buttons show. Drag icons to reorder.",
    ["Drag the preview icons to reorder. The clock remains centered. Check items below to show them."] = "Drag icons to reorder. Clock stays centered.",
    ["Enable items below to preview and drag them."] = "Enable items below to preview them.",
    ["Drag the visible items to reorder this info bar."] = "Drag visible items to reorder.",
    ["Drag the visible items to change their order on this info bar."] = "Drag visible items to reorder this bar.",
    ["Max 5 shown. Drag the preview above or use the arrows to reorder."] = "Max 5. Drag the preview or use arrows.",
    ["Max 5 shown. Drag the preview items to reorder."] = "Max 5. Drag preview items to reorder.",
    ...
    ["Show the detected group-finder addon name on this info bar. Left-click opens its UI."] = "Show the detected addon name. Left-click opens it.",
    ["Primary Professions"] = "Primary Professions",
    ["Secondary Professions"] = "Secondary Professions",
    ["Show learned primary profession icons. Left-click opens the first profession and right-click opens the second."] = "Show primary profession icons. Left first, right second.",
    ["Show learned Cooking, Fishing, and Archaeology icons. Left-click opens Cooking, right-click opens Fishing, and middle-click opens Archaeology."] = "Show secondary profession icons. Left Cooking, right Fishing, middle Archaeology.",
...
local englishShortDescriptionOverrides = {
    ...
    ["Choose which mount each mouse button summons from the info-bar mount icon."] = "Set info-bar mount clicks.",
    ["Choose the mount summoned by left-clicking the info-bar mount icon."] = "Left-click mount.",
    ["Choose the mount summoned by middle-clicking the info-bar mount icon."] = "Middle-click mount.",
    ["Choose the mount summoned by right-clicking the info-bar mount icon."] = "Right-click mount.",
    ["Left click chooses a saved talent loadout. Right click changes loot specialization."] = "Left: talent loadout. Right: loot spec.",
    ...
    ["Show the detected group-finder addon name on this info bar. Left-click opens its UI."] = "Detected addon name. Left-click opens it.",
    ["Primary Professions"] = "Primary Profs",
    ["Secondary Professions"] = "Secondary Profs",
    ["Show learned primary profession icons. Left-click opens the first profession and right-click opens the second."] = "Primary icons. Left first, right second.",
    ["Show learned Cooking, Fishing, and Archaeology icons. Left-click opens Cooking, right-click opens Fishing, and middle-click opens Archaeology."] = "Secondary icons. Left cook, right fish, middle archaeology.",
    ...
    ["Show time and raid lockouts. Left click opens calendar."] = "Time + raid lockouts.",
    ...
    -- Extra compact labels for dropdown options / row names that still
    -- overflow narrow UI rows (audited 2026-08-17, aligned with deDE/ruRU)
    ["Class Color: Icons Only"] = "Icons Only",
    ["Class Color: Clock Only"] = "Clock Only",
    ["Class Color: Icons"] = "Icons",
    ["Class Color: Clock"] = "Clock",
    ["Class Color: All"] = "All",
    ["Class Color (Except Icons)"] = "Except Icons",
    ["Class Color (Except Time)"] = "Except Time",
    ["Class Color (All)"] = "Class All",
    ["Texture Color"] = "Texture",
    ["Outer Top and Bottom Lines"] = "Outer Lines",
    ["Thin Line Top and Bottom"] = "Thin Both",
    ["Thin Line Top"] = "Thin Top",
    ["Thin Line Bottom"] = "Thin Bottom",
    ["Fade, show in combat"] = "Fade + Combat",
    ["Fade except time"] = "Fade, Keep Time",
    ["Random Hearthstone"] = "Random HS",
    ["Dalaran Hearthstone"] = "Dalaran HS",
    ["Left Click: Hearthstone"] = "Left: Hearthstone",
    ["Right Click: Dalaran Hearthstone"] = "Right: Dalaran HS",
    ["Blizzard Native Micro Menu"] = "Native Menu",
    ["Blizzard Native Bag Bar"] = "Native Bag Bar",
    ["Top-Center Zone Information"] = "Top-Center Zone",
    ["System Bar Color"] = "Bar Color",
    ["Text / Icon Color"] = "Text/Icon",
    ["Button Spacing"] = "Spacing",
    ["Fade In Duration"] = "Fade In",
    ["Fade Out Duration"] = "Fade Out",
    ["Enable Time Text Options"] = "Time Text",
    ["Show Durability Number"] = "Dura Number",
    ["Show Online Friends"] = "Show Friends",
    ["Show Online Guild Members"] = "Show Guild Online",
    ["Show Free Bag Slots"] = "Show Bag Slots",
    ["Online Friends"] = "Friends Online",
    ["Online Guild Members"] = "Guild Online",
    ["Free Bag Slots"] = "Free Bags",
    ["Equipped Durability"] = "Equipped Dura",
    ["Enable Left Info Bar"] = "Enable Left",
    ["Enable Right Info Bar"] = "Enable Right",
}
